...
export interface PancakeSwapGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addSupportedRouter"
      | "convert32toAddress"
  ...
  encodeFunctionData(
    functionFragment: "addSupportedRouter",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "removeSupportedRouter",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface PancakeSwapGuard extends BaseContract {
  connect(runner?: ContractRunner | null): PancakeSwapGuard;
  waitForDeployment(): Promise<this>;

  interface: PancakeSwapGuardInterface;
  ...
  addSupportedRouter: TypedContractMethod<
    [router: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  removeSupportedRouter: TypedContractMethod<
    [router: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "addSupportedRouter"
  ...
  >;
  getFunction(
    nameOrSignature: "removeSupportedRouter"
  ): TypedContractMethod<[router: AddressLike], [void], "nonpayable">;
  getFunction(
