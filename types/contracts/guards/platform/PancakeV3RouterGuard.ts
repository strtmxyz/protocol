...
export interface PancakeV3RouterGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "convert32toAddress"
      | "getArrayIndex"
...
export interface PancakeV3RouterGuard extends BaseContract {
  connect(runner?: ContractRunner | null): PancakeV3RouterGuard;
  waitForDeployment(): Promise<this>;

  interface: PancakeV3RouterGuardInterface;
