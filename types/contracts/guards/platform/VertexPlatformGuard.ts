...
export interface VertexPlatformGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "convert32toAddress"
      | "getArrayIndex"
...
export interface VertexPlatformGuard extends BaseContract {
  connect(runner?: ContractRunner | null): VertexPlatformGuard;
  waitForDeployment(): Promise<this>;

  interface: VertexPlatformGuardInterface;
