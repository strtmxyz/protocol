...
export interface PancakeV2RouterGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "convert32toAddress"
      | "getArrayIndex"
...
export interface PancakeV2RouterGuard extends BaseContract {
  connect(runner?: ContractRunner | null): PancakeV2RouterGuard;
  waitForDeployment(): Promise<this>;

  interface: PancakeV2RouterGuardInterface;
