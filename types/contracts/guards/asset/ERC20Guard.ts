...
export interface ERC20GuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "calcValue"
...
export interface ERC20Guard extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Guard;
  waitForDeployment(): Promise<this>;

  interface: ERC20GuardInterface;
