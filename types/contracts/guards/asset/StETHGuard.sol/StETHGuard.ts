...
export interface StETHGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ETH_ADDRESS"
      | "STETH_ADDRESS"
...
export interface StETHGuard extends BaseContract {
  connect(runner?: ContractRunner | null): StETHGuard;
  waitForDeployment(): Promise<this>;

  interface: StETHGuardInterface;
  ...
  STETH_ADDRESS: TypedContractMethod<[], [string], "view">;
