...
export interface ETHGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "calcValue"
...
export interface ETHGuard extends BaseContract {
  connect(runner?: ContractRunner | null): ETHGuard;
  waitForDeployment(): Promise<this>;

  interface: ETHGuardInterface;
