...
export interface VertexAssetGuardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "calcValue"
      | "convert32toAddress"
...
export interface VertexAssetGuard extends BaseContract {
  connect(runner?: ContractRunner | null): VertexAssetGuard;
  waitForDeployment(): Promise<this>;

  interface: VertexAssetGuardInterface;
  ...
  calcValue: TypedContractMethod<
    [vault: AddressLike, asset: AddressLike, arg2: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getSubaccountId: TypedContractMethod<
    [vault: AddressLike, suffix: BytesLike],
    [string],
    "view"
  >;
